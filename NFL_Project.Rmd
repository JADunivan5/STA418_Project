...
```{r Play Type Yardage}
Playtype_Yardage <- NFL %>% filter(!play_type%in%c("TIMEOUT","CLOCK STOP", "EXCEPTION", "PENALTY","KICK OFF","EXTRA POINT", "QB KNEEL", is.na(play_type))) %>%  
  count(yards, play_type)
Playtype_Yardage
#Want to look into removing rows that contain, Timeouts, QB-Kneel, End of game, End of Quarter
```
